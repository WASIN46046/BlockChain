            ...
            <div className="bg-white px-4 py-5 sm:px-6">
                ...
                <div className="max-w-7xl mx-auto py-3 px-3 sm:px-3 lg:px-3">
                  <div className="flex items-center justify-between flex-wrap">
                    ...
                    <div className="order-2 flex-shrink-0 sm:order-3 sm:ml-3">
                      <button type="button" className="-mr-1 flex p-2 rounded-md hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-white sm:-mr-2">
              ...
              <div className="mt-2">
                <div className="mt-1 relative rounded-md w-72">
                  <input
                    ...
                    name="price"
                    id="price"
                    className="focus:ring-red-500 shadow-md focus:border-red-500 block pl-7 p-4 sm:text-sm border-gray-300 rounded-md" placeholder="x@y.com" />
                  <div className="absolute inset-y-0 right-0 flex items-center">
                    <label htmlFor="currency" className="sr-only">Currency</label>
                    <div className="flex lg:justify-start">
                      <div className="rounded-md shadow">
                        <a href="#" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-sm rounded-md text-white bg-red-600 hover:bg-red-700 md:py-4 md:px-10">
                         ค้นหา
                        </a>
                      </div>
                    </div>
              ...
              <div className="relative inline-block w-full text-gray-700">
                <select className="w-72 h-10 pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline" placeholder="Regular input">
                  <option>เลือกปกติ</option>
                  <option>ตัวเลือกอื่น ๆ</option>
                  <option>มากกว่าหนึ่ง</option>
                </select>
